...
tags: [Elixir, Plug]
pubDate: 2016-08-14 17:56:00 +0200
---

This is a continuation of [Hello World web app in Elixir, part&nbsp;1 - Cowboy](/2016/08/14/hello-world-web-app-in-elixir-part-1-cowboy). I am going to reference that post a few times because there are many similarities between the two apps, so you should probably read that first.
...
It's very similar to [the first one](/2016/08/14/hello-world-web-app-in-elixir-part-1-cowboy#mixfile). I added Plug to both `deps` and `applications`. I am also using a stable older version of Cowboy, as advised in Plug's docs.
...
Again, almost identical as [the first one](/2016/08/14/hello-world-web-app-in-elixir-part-1-cowboy#config) except for a different port number (`8001 -> 8002`), to be able to run both apps at the same time.
...
- [Part 1 - Cowboy](/2016/08/14/hello-world-web-app-in-elixir-part-1-cowboy)
- [Part 3 - Phoenix](/2016/08/14/hello-world-web-app-in-elixir-part-3-phoenix)
