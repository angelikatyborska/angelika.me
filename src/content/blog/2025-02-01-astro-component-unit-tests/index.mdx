...
In [Astro 5.15.6](https://github.com/withastro/astro/releases/tag/astro@5.15.6), it [became impossible to render Astro components "in the browser"](https://github.com/withastro/astro/pull/14751), including happy-dom.
...
[See example code](https://github.com/angelikatyborska/astro-component-unit-tests/commit/ff55d65d629eb10ee8f3139e7af6762ce6243527).
...
_Edited on 29.03.2026: added solution for Astro 5.15.6._
