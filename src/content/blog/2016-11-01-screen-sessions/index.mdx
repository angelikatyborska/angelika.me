...
pubDate: 2016-11-01 22:01:00 +0100
---

import BlogPostImage from "@components/BlogPostImage.astro"
import CtrlAQuestionMark from "ctrl-a-question-mark.png"
import MultiDisplayMode from "multi-display-mode.gif"
import StartDetachAttach from "start-detach-attach.gif"
...
<BlogPostImage
  image={StartDetachAttach}
  alt={"Screen session does not terminate when you detach"}
>
  <Fragment slot="caption">Create a screen session, detach <kbd>Ctrl</kbd>+<kbd>a</kbd>, <kbd>d</kbd> and attach again - loop still running</Fragment>
</BlogPostImage>
...
<BlogPostImage
  image={MultiDisplayMode}
  alt={'Screen session does not terminate when you detach'}
  caption={'Multi display mode'}
/>
...
<BlogPostImage
  image={Windows}
  alt={'Multiple windows in a single session'}
>
  <Fragment slot="caption">Create a screen session, type, create a new window in that session <kbd>Ctrl</kbd>+<kbd>a</kbd>, <kbd>c</kbd>, type, switch windows <kbd>Ctrl</kbd>+<kbd>a</kbd>, <kbd>"</kbd>, exit both windows.</Fragment>
</BlogPostImage>
...
<BlogPostImage
  image={CtrlAQuestionMark}
  alt={'screen key bindings'}
>
  <Fragment slot="caption">Screen key bindings - show by pressing <kbd>Ctrl</kbd>+<kbd>a</kbd>, <kbd>?</kbd></Fragment>
</BlogPostImage>
