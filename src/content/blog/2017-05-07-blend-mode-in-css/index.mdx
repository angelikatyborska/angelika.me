...
tags: [CSS]
pubDate: 2017-05-07 15:39:00 +0200
---

import BlogPostImage from "@components/BlogPostImage.astro"
import MyBoundingBox from './my-bounding-box.png'
...
<BlogPostImage
  image={MyBoundingBox}
  alt="My bounding box"
  caption="A Photoshop-like bounding box made up of two inline SVGs over a canvas displaying a photo of my unamused cat"
/>
