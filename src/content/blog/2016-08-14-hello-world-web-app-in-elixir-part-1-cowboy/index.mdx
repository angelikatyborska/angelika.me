...
tags: [Elixir, Cowboy]
pubDate: 2016-08-14 17:55:00 +0200
---

import BlogPostImage from "@components/BlogPostImage.astro"
import HelloWorld from "hello-world.png"
import ProcessInformation from "process-information.png"
import Ranch100 from "ranch-100.png"
...
<BlogPostImage
  image={HelloWorld}
  alt={"The app's process tree"}
  caption={"Not much here, huh?"}
/>
...
<BlogPostImage
  image={ProcessInformation}
  alt={'Process information'}
  caption={"I don't know who you are, <0.143.0>, but I will find you and I will inspect your tree."}
/>
...
<BlogPostImage
  image={Ranch100}
  alt={"Ranch's process tree"}
  caption={"Here they are! All 100 of them (notice the long scrollbar)."}
/>
