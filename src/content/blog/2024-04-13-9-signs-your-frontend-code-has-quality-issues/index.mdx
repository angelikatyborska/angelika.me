...
pubDate: 2024-04-13 18:47:00 +0200
---

import BlogPostImage from "@components/BlogPostImage.astro";
import ClickableAreaBig from "./clickable-area-big.gif";
import ClickableAreaSmall from "./clickable-area-small.gif";
import CoreWebVitals from "./core-web-vitals.png";
...
<BlogPostImage
  image={ClickableAreaSmall}
  alt={"Three icon buttons in a row, with some margin in between them. Cursor moving from button to button only triggers hover state over the button when it\'s exactly over the icon."}
  caption={"Margin vs..."}
/>

<BlogPostImage
  image={ClickableAreaBig}
  alt={"Three icon buttons in a row, with some padding inside each button. Cursor moving from button to button triggers hover state of the closest button."}
  caption={"...padding"}
/>
...
<BlogPostImage
  image={CoreWebVitals}
  alt={"Core web vitals assessment failed. Largest contentful paint red, 8.6 seconds. Interaction to next paint yellow, 413 ms. Cumulative layout shift yellow, 0.23"}
>
  <Fragment slot="caption">Core web vitals assessment from <a href="https://pagespeed.web.dev/">pagespeed.web.dev</a> for a certain (in)famous social media website.</Fragment>
</BlogPostImage>
