...
pubDate: 2024-06-10 06:15:00 +0200
---

import BlogPostImage from "@components/BlogPostImage.astro";
import CriticalIssue from "./critical-issue.png";
...
<BlogPostImage
  image={CriticalIssue}
  alt="Expected page to have no accessibility violations, but got 1 violation. Form elements must have labels."
  caption="Accessibility violations will cause your tests to fail, printing all violations sorted by severity."
/>
