...
pubDate: 2016-03-08 21:43:00 +0100
---
...
```html
{% include love.html name="Angelika" %}
```
...
```
My favorite color is {{ site.favorites.color }}.
```
...
```html
{% img my_logo alt='My Logo' class:'logo' %}
```
