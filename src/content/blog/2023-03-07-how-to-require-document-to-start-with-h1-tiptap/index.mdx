...
pubDate: 2023-03-07 10:22:00 +0100
---
...
<BlogPostImage
  image={Step0}
  alt="TipTap editor with formatting buttons: h1 to h6, bold, italic. The editing area is empty, with a placeholder text: what's on your mind?"
  caption="Starting point: empty paragraph with a placeholder."
/>
...
<BlogPostImage
  image={Step3}
  alt="TipTap editor with formatting buttons: h1 to h6, bold, italic. The h1 to h6 buttons are disabled. The editing area is empty, with a two placeholder texts, a big one and a small one. The big one says: what's the title?, and the small one says: what's on your mind?"
  caption="End goal: empty editor with two placeholders, one for the required title, and one for the empty paragraph."
/>
