...
tags: [Elixir, Phoenix]
pubDate: 2016-08-14 17:57:00 +0200
---

This is a continuation of [Hello World web app in Elixir, part&nbsp;2 - Plug](/2016/08/14/hello-world-web-app-in-elixir-part-2-plug).
...
[`put_status/2`](https://hexdocs.pm/plug/Plug.Conn.html#put_status/2) is Plug's function for setting the response status without sending a response yet. [`text/2`](https://hexdocs.pm/phoenix/Phoenix.Controller.html#text/2) is a Phoenix's function for responding with plain text. I could have also written it exactly [like in part 2](/2016/08/14/hello-world-web-app-in-elixir-part-2-plug#helloworldrouter):
...
- [Part 2 - Plug](/2016/08/14/hello-world-web-app-in-elixir-part-2-plug)
