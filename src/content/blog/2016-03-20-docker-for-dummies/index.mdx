...
pubDate: 2016-03-20 15:28:00 +0100
---

import BlogPostImage from "@components/BlogPostImage.astro"
import BrowserNodatabase from "./browser_nodatabase.png";
import BrowserSuccess from "./browser_success.png";
import DockerOsx from "./docker_osx.svg";
import DockerOsxFolder from "./docker_osx_folder.svg";
import VmShell from "./vm_shell.png";
...
<BlogPostImage
  image={DockerOsx}
  alt={'A diagram showing Docker on Mac OS X'}
  caption={"Tiny virtual computers inside a virtual computer inside a real computer."}
/>
...
<BlogPostImage
  image={DockerOsxFolder}
  alt={'A diagram showing Docker containers sharing files with Mac OS X'}
  caption={"Tiny virtual computers sharing files with a virtual computer sharing files with a real computer."}
/>
...
<BlogPostImage
  image={VmShell}
  alt={'A screen from Docker default machine'}
  caption={"Checking that the Linux VM in fact has access to my OS X home directory"}
/>
...
<BlogPostImage
  image={BrowserNodatabase}
  alt={'Rails app showing a ActiveRecord::NoDatabaseError error'}
/>
...
<BlogPostImage
  image={BrowserSuccess}
  alt={'Rails app working correctly'}
/>
