...
tags: [first job]
pubDate: 2016-06-06 21:46:00 +0200
---

import BlogPostImage from "@components/BlogPostImage.astro";
import GoToDeclaration from "./go-to-declaration.gif"
...
<BlogPostImage
  image={GoToDeclaration}
  alt={'Go To Declaration in RubyMine'}
  caption={"What would I do without you, RubyMine?"}
/>
