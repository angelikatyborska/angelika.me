...
pubDate: 2016-03-12 16:15:00 +0100
---

import BlogPostImage from "@components/BlogPostImage.astro"
import EmacsMode from "./emacs-mode.gif"
import NoShortcuts from "./no-shortcuts.gif"

You're about to run a command only to notice a typo at the beginning. Looks familiar?

<BlogPostImage
  image={NoShortcuts}
  alt={'Navigating to a typo without shortcuts'}
  caption={"Navigating to a typo without shortcuts."}
/>
...
<BlogPostImage
  image={EmacsMode}
  alt={'Navigating to a typo with shortcuts.'}
  caption={"Navigating to a typo with shortcuts."}
/>
