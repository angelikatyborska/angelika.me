...
<figure>
  ...
  <figcaption>
    One of those images has alt text, the other doesn't. But which one is which? Odit quibusdam
    tempore deserunt. Sapiente magni amet alias nostrum et maiores. Dolorum deleniti dolore fugiat
    dolorem quis.
  </figcaption>
</figure>
...
<figure>
  <a href={Placeholder.src}>
    <Image src={Placeholder} class="half-width" alt="Problems with summing character codes" />
  </a>
