...
pubDate: 2020-07-25 16:53:00 +0200
---

import BlogPostImage from "@components/BlogPostImage.astro";
import Solution from "./solution.gif"
import WikipediaHiddenSkipLink from "./wikipedia_hidden_skip_link.gif"
import WikipediaTableOfContents from "./wikipedia_table_of_contents.gif"
...
<BlogPostImage
  image={WikipediaTableOfContents}
  alt={'A gif showing navigating a Wikipedia article with its table of contents'}
  caption={"You can use the table of contents on Wikipedia to jump straight to the section that interests you the most."}
/>

<BlogPostImage
  image={WikipediaHiddenSkipLink}
  alt={'A gif showing a skip link on Wikipedia'}
  caption={"Wikipedia also has some hidden skip links, for example to jump straight to the search."}
/>
...
<BlogPostImage
  image={Solution}
  alt={'A gif showing using keyboard navigation on an example Vue app with a lot of text that has a table of contents.'}
  caption={'Our solution in action.'}
/>
