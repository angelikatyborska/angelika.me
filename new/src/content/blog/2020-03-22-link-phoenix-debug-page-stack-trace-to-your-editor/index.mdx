...
<BlogPostImage
  image={LinkStackTrace}
  alt={'A gif showing a debug page in Phoenix and how clicking on a file name opens that file in RubyMine'}
  caption={"When I click on the file name in the stack trace, that file opens in RubyMine, on the line that caused the error."}
