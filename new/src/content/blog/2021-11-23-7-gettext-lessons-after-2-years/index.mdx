...
pubDate: 2021-11-23 21:01:00 +0100
---

import BlogPostImage from "@components/BlogPostImage.astro";
import CrowdinTranslatorUi from './crowdin-translator-ui.png';
...
<BlogPostImage
  image={CrowdinTranslatorUi}
  alt={'A screenshot of the translator UI offered by Crowdin'}
>
  <Fragment slot="caption">On <a href="https://crowdin.com/">Crowdin</a>, HTML tags in original strings are highlighted, and translators are warned before saving a translation with missing tags.</Fragment>
</BlogPostImage>
